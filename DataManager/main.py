...
def SaveData(text: list):
    ...
    with open("DataManager/data.data", "w", encoding='utf-8') as file:
        placetab = False
...
def OpenDataToRead() -> list:
    ...
    with open("DataManager/data.data", "r", encoding="utf-8") as file:
...
def CreateChapter(chapter_name: str):
    ...
    if not isChapterExist(chapter_name):
        with open("DataManager/data.data", "a", encoding="utf-8") as file:
